...
alter  table cadces01 add ces01_codces int default 00
go
...
--// drop index id_cadces01_000 on cadces01

create unique clustered index id_cadces01_000 on cadces01(ces01_codces)
go
